...
class ValidationParticipationOutsideEvents extends AbstractValidationPartipation
{
    protected function checkPlacesNumber(Participation $participation) : void
    {
        ...
        echo "Le nombre de places restantes pour l'évènement en extérieur à été vérifié !";
        echo "\n";
    }
    ...
    protected function sendValidation(Participation $participation) : void
    {
        ...
        echo "Tout est en ordre, le participant {$identityParticipant} est inscrit à l'évènement en extérieur {$event} !";
        echo "\n";
    }
}